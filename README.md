...
- [ก่อนเริ่มต้น](#ก่อนเริ่มต้น)
    ...
    - [ลบTempolate](#คำสั่งสำหรับลบ-template-ถ้าไม่อยากใช้แล้ว-t_t)
- [เริ่มต้น](#เริ่มต้นง่ายๆ-ด้วยโปรเจคใหม่)
    - [ติดตั้งPackage](#ติดตั้ง-rampagemvvc-package)
    - [อธิบายการทำงาน](#อธิบายโครงสร้าง-การทำงาน)
        - [ViewController](#homeviewcontrollerswift)
        - [UI interface XIB](#homeviewcontrollerxib)
        - [View](#homeviewswift)
            - [onStart เมื่อ Viewเริ่มทำงาน](#onstart)
        ...
        - [ViewModel](#homeviewmodelswift)
            - [Async Await](#async-await)
        - [Service](#homeservicesswift)
        - [Model](#homemodelswift)
...
## คำสั่งสำหรับลบ template ถ้าไม่อยากใช้แล้ว T_T
uninstall command
```
git clone git@github.com:heart/RampageMVVM-iOS-Swift.git
cd "RampageMVVM-iOS-Swift/xcode templates"
